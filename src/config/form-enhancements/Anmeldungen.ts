...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["termin", {"row": ["vorname", "nachname"]}, "email", "telefon", "anmeldedatum", "anmeldequelle", "status_anmeldung", "notizen_anmeldung"],
  defaults: {
    'anmeldedatum': { kind: 'today', withTime: true },
    'status_anmeldung': { kind: 'lookup', key: 'neu', label: 'Neu / Ausstehend' },
  },
  computed: {},
};
